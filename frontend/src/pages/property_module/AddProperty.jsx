    ...
    try {
      ...
      if (newPropertyId && brochureFile && brochureFile.type === "application/pdf") {
        try {
          ...
          await API.post(`/properties/${newPropertyId}/brochure`, formData, {
      ...
      if (finalAssignee !== currentUserId) {
        ...
        successMsg = brochureUploaded
          ? `Property and brochure saved and assigned to ${assigneeName}!`
          : `Property assigned to ${assigneeName}!`;
      }
