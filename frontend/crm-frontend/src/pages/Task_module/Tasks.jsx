...
const Tasks = () => {
  ...
  const [expandedTasks, setExpandedTasks] = useState({}); // Tracking which descriptions are open
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <h2>
          <Calendar color="#2563eb" /> Task Manager
        </h2>
        ...
        {tasks.length === 0 ? (
          ...
          tasks.map((task) => (
            ...
            >
                ...
                <div className={styles.actions}>
                  ...
                  >
                    <CheckCircle
                      size={24}
                      color={
                        task.status === "completed" ? "#16a34a" : "#cbd5e1"
                      }
                    />
                  </button>
                  <button
              ...
              {expandedTasks[task._id] && task.description && (
